            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 pt-4" style={{minHeight:"500px"}} >
                    <div class="position-relative h-100 wow fadeInUp" data-wow-delay="0.5s">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/about-1.jpg" style={{objectFit: "cover", padding: "0 0 50px 100px", alt:""}}/>
                        <img class="position-absolute start-0 bottom-0 img-fluid bg-white pt-2 pe-2 w-50 h-50" src="img/about-2.jpg" style={{objectFit: "cover", alt:""}}/>
                    </div>
                </div>
            </div>
        </div>
